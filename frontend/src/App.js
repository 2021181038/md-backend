...
function App() {
  ...
  ${dateText}より、ご注文順に順次出荷されます。できるだけ早くお届けできるよう努めます。<br><br>

  *「入金待ち」*の状態が続きますと、現地での商品確保ができず、ご注文がキャンセルになる場合がございます。できるだけ早い決済をお願いいたします。<br><br>

  関税はこちらで負担いたしますのでご安心ください。<br><br>

  商品はすべて100%正規品です。<br><br>
  ...
  ご不明な点やご希望がございましたら、いつでもお気軽にお問い合わせください ^^<br><br>
  `;
