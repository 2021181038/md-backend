  ...
  return (
    <div style={{ marginTop: '30px' }}>
              ...
              <tr key={idx}>
                <td>
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    <input
                      ...
                      value={item.name}
                      onChange={(e) => updateMdItem(idx, "name", e.target.value)}
                    />
                    {item.name.length > 50 && (
                ...
                <td>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px", justifyContent: "center" }}>
                    <input
                      ...
                      placeholder="₩원화 입력"
                      value={item.price}
                      onChange={(e) => updateMdItem(idx, "price", e.target.value)}
                    />
                    <button
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => updateMdItem(idx, "hasOption", e.target.checked)}
                  />
                  {item.hasOption && (
                    <input
                      type="text"
                      ...
                      onChange={(e) => updateMdItem(idx, "optionText", e.target.value)}
                      style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "10px", marginTop: "20px", marginBottom: "15px" }}>
        <button className="plus-button" onClick={addMdItem}>
          상품 추가 +
        </button>
      </div>
    </div>
